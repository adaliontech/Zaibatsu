...
Candidate binding itself creates no validation plan and no regression,
rollback, approval, promotion, rollout, activation, execution, or
cross-factory authority follows.

## Plan validation without executing it

Reverify the exact candidate and its complete source chain, then enumerate the
mandatory validation work without running it:
...
The checked [plan specification](examples/economic-factory.improvement-validation-plan-spec.json)
...
- [Improvement-validation-plan specification](examples/economic-factory.improvement-validation-plan-spec.json)
  and [derived plan](examples/economic-factory.improvement-validation-plan.json)
...
20. Candidate binding proves exact contract identity and target alignment; it
    ...
    validation.
21. An improvement validation plan enumerates required work and missing
