...
| A forged, reordered, replayed, or authority-inflated rebuild graph is treated as permission to act | Rebuild planning fully reverifies the exact bundle, release source lock, qualification policy, plan, evidence, and assessment; reproduces the nine actions, dependencies, blockers, statuses, and four gates byte-for-byte; rejects type confusion and altered inputs; and fixes every execution, side-effect, qualification, approval, activation, deployment, and recovery authority claim to false |
