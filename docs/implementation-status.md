...
| Recursive shared improvement | Return, proposal intake, structural normalization, classification, exact candidate binding, deterministic non-executing validation planning, and portable input packaging operational at bounded public-kit scope; broader loop designed | Evidence-return, proposal, observation, classification, candidate-binding, validation-plan, and validation-input-pack contracts plus lifecycle and promotion contract | Exact untrusted proposals and reports can be bound to verified returned evidence, an aligned candidate contract can be content-addressed, and its required validation inputs and work can be reproduced; safety results, semantic validation, implementation, validation execution, promotion, and cross-factory rollout are not deployed |
...
| Evidence-bound structural observation normalization | Operational in the public kit | Two project-owned schemas, exact evidence-return re-verification, canonical category/subject/digest binding, and weakening/replay/forgery/type/size/authority adversarial tests | One untrusted observation, failure, artifact outcome, or correction is put into a bounded canonical shape against exact returned evidence. Structural normalization does not authenticate the reporter, scan content safety or secrets, or prove source/report truth, merit, promotion, execution, or cross-factory effects |
| Deterministic improvement-candidate classification | Operational in the public kit | Separately hashed policy and record schemas, full proposal/observation chain re-verification, fixed-order checks, deterministic rejection records, and policy/mismatch/replay/forgery/type/order/CLI adversarial tests | One aligned pair is classified by workflow/type as eligible for validation planning. Classification itself creates no plan, decides no safety or semantic merit, authorizes no test or mutation, obtains no owner approval, and grants no promotion, rollout, activation, execution, or cross-factory effect |
| Evidence-bound improvement-candidate contract | Operational in the public kit | Two project-owned schemas, complete classification-chain re-verification, canonical candidate-contract digest, exact target alignment, and weakening/replay/forgery/type/order/CLI adversarial tests | One exact shared-module, factory-template, or deterministic-gate contract can be bound to an eligible classification. The checked artifact is a non-executable, explicitly untrusted contract; content safety, secret absence, semantic correctness, implementation, validation planning or execution, regression, rollback, approval, promotion, rollout, activation, execution, and cross-factory effects remain false |
| Deterministic improvement validation plan | Operational in the public kit | Two project-owned schemas, complete candidate-chain re-verification, fixed eight-stage order, twelve content-addressed evidence requirements, exact reconstruction, and weakening/replay/forgery/type/order/CLI adversarial tests | The exact candidate expands into an inert work inventory: all 8 stages are `not_run`, all 12 evidence artifacts are `missing`, executed/passed/failed counts are zero, no implementation exists, and validation success, approval, promotion, rollout, activation, execution, and cross-factory effects remain false |
| Portable improvement-validation input pack | Operational in the public kit | Digest-pinned manifest schema, exact 21-member canonical USTAR, complete candidate-chain and nested-archive re-verification, byte-identical reconstruction, and archive/schema/replay/authority/type/order/bounds/CLI adversarial tests | A verifier can receive the complete data input set in one deterministic archive. The pack omits its verifier implementation and environment, candidate implementation, validation-stage evidence, and every readiness, approval, promotion, rollout, activation, execution, or cross-factory authority. Verification needs no live production credential or state, but arbitrary embedded evidence is not content-scanned and secret absence is not proved |
...
- deployed enforcement of namespaces named by the public factory portfolio
  plan;
- observed delivery or promotion of the public route-bound evidence-return
  record;
- authentication, semantic validation, merit, or promotion of the public
  evidence-bound improvement proposal or structurally normalized observation;
- safety, semantic correctness, implementation, or validation of the public
  evidence-bound candidate contract;
- the implementation, evidence production, authorization, or execution named
  by the public improvement validation plan;
