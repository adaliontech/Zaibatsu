...
| Runnable quickstart | [`docs/reproducibility.md`](reproducibility.md) | Immutable v1.15.0 passed 247-test, 120-file credential-disabled full-history candidate and tag clones, candidate/roof/tag CI, both Gitleaks modes, two live-v1.15-schema byte checks, sixteen strict schemas, byte-identical candidate regeneration, and contract-only semantic proof |
