...
| Runnable quickstart | [`docs/reproducibility.md`](reproducibility.md) | Immutable v1.6.0 passed its 163-test release boundary; the v1.7.0 source-lock candidate requires its own 173-test full-history clone, independent CI, tagged-schema, Gitleaks, and deterministic-artifact proof |
...
v1.7.0 source-lock candidate still requires its independent public release
