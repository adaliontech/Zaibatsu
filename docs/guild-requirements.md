...
v1.7.0 source-lock candidate passed its independent public-clone and CI proof;
immutable release proof, the final clip, and applicant-owned form submission
remain.
