...
| --- | --- | --- |
| Architecture validator | Current package passed locally; v1.8.0 separately passed candidate, tag-clone, and CI proof | Current validator requires 87 files and checks 13 components, 3 software factories, 2 portable definitions, 10 catalog modules, bundle/source/qualification/signed-runtime/rebuild contracts and schemas, 11 meta-factory capabilities, 4 sanitized receipts, 9 meta-factory invariants, 8 component invariants, and 10 submission gates. The immutable v1.8.0 proof remains the latest released baseline until v1.9.0 candidate proof completes |
| Adversarial unit tests | Current package passed locally; v1.8.0 separately passed candidate, tag-clone, and CI proof | 194 of 194 current tests passed; immutable v1.8.0 passed its historical 183-test boundary |
