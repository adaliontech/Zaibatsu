...
| --- | --- | --- |
| Architecture validator | Passed locally after bundle-derived qualification-evidence expansion | 72 required files, 13 components, 3 current software factories, 2 portable definition variants, 10 catalog modules and content-addressed artifacts, 1 resolved control plan and bundle manifest, 6 inspection/comparison/qualification schemas, 1 qualification policy, 1 plan, 1 evidence set, 1 partial assessment, 11 meta-factory capabilities, 4 sanitized evidence receipts, 9 meta-factory invariants, 8 component invariants, and 10 submission gates checked; current candidate reproduction remains pending |
| Adversarial unit tests | Passed locally after bundle-derived qualification-evidence expansion | 163 of 163 tests passed; current candidate CI and credential-disabled fresh-clone proof remain pending |
...
| Independent secret scan | Passed on v1.5.0 candidate and tag clones | Checksum-pinned Gitleaks `8.30.1` found no leaks in the full public Git history, candidate tree, or immutable tag tree; GitHub secret scanning and push protection provide a separate repository guard |
...
| v1.6.0 candidate proof | Pending | Canonical-JSON qualification-evidence digest `a19e1f82e13f6a7e07011c6e80e112d4981740e9188805e615ee57e12c9d1963` (file SHA-256 `0e986a355998210f1e31ece296def22fd115f9985d22d6a8522055fcf98c08c1`) and canonical-JSON qualification-assessment digest `465fc52b7941bda938480767277af39b4677cc23e5817273845e9c8e0711d8d2` (file SHA-256 `0ec2d40c351ff2add63ed62f85fbdd8cd6a36863cbef77dd7c98c59736fdd2da`) are locally reproducible; candidate CI, strict Git, Gitleaks, AJV, and credential-disabled clone proof remain required |
