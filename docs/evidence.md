...
| Independent secret scan | Passed on the v1.7.0 candidate clone and prior immutable releases | Checksum-pinned Gitleaks `8.30.1` found no leaks in the full public Git history or candidate tree; GitHub secret scanning and push protection provide a separate repository guard |
