...
| Independent secret scan | Passed locally, in CI, and from a credential-disabled full-history v1.8.0 candidate clone | Checksum-pinned Gitleaks `8.30.1` found no leaks in the full public Git history or candidate tree; GitHub secret scanning and push protection provide a separate repository guard |
