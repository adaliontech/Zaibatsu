...
| --- | --- | --- |
| Architecture validator | v1.9.0 passed locally, from credential-disabled candidate and tag clones, and in candidate, roof, and tag CI | Current validator requires 87 files and checks 13 components, 3 software factories, 2 portable definitions, 10 catalog modules, bundle/source/qualification/signed-runtime/rebuild contracts and schemas, 11 meta-factory capabilities, 4 sanitized receipts, 9 meta-factory invariants, 8 component invariants, and 10 submission gates |
| Adversarial unit tests | v1.9.0 passed locally, from credential-disabled candidate and tag clones, and in candidate, roof, and tag CI | 194 of 194 current tests passed at every final v1.9.0 validation boundary |
...
| Signed runtime-evidence local proof | Passed locally 2026-08-30 | OpenSSH 8.9p1 verified the checked Ed25519 fixture after its temporary private key was deleted; 194 tests and the 87-file validator passed. Canonical digests are registry `9196fd8a8afbb161bdc8f5d2fad1a28bef467ff6786c3f732d2d4c187079bff6`, signed evidence `d084a11b7cda2ec8615f583a07ba6b219913249e35cd6d54c0dea191809eba77`, runtime assessment `4eb09dd60ad709b849602a0768165fade53cfb5800a00d0c6769f676a7f6ac26`, and rebuild plan `a7ae3bc1371b8700cd71e0e2d6d696528c44e95c76ef426dc1a9f19ac24d02a5`. The checked fixture records 10 verified bindings, 57 missing, zero eligible modules, and false activation/execution authority |
...
| Independent secret scan | v1.9.0 passed locally, from credential-disabled candidate and tag clones, and in candidate, roof, and tag CI | Checksum-pinned Gitleaks `8.30.1` found no leaks in the full public Git history or current tree; the immutable v1.9.0 tag tree passed separately, and GitHub secret scanning and push protection provide independent repository guards |
