...
| Independent secret scan | Passed on v1.5.0 candidate | Checksum-pinned Gitleaks `8.30.1` found no leaks in the full public Git history or candidate tree; GitHub secret scanning and push protection provide a separate repository guard |
...
| Demo recording | Pending applicant action after immutable v1.5.0 release | Record from the released tag using the [Demo script](demo-script.md) |
