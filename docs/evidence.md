...
| --- | --- | --- |
| Architecture validator | Passed on the current local candidate; prior v1.6.0 candidate and tag clones remain independently proved | 75 required files, 13 components, 3 current software factories, 2 portable definition variants, 10 catalog modules and content-addressed artifacts, 1 resolved control plan, bundle manifest, and annotated-release source lock, inspection/comparison/qualification schemas, 1 qualification policy, 1 plan, 1 evidence set, 1 partial assessment, 11 meta-factory capabilities, 4 sanitized evidence receipts, 9 meta-factory invariants, 8 component invariants, and 10 submission gates checked |
| Adversarial unit tests | Passed on the current local candidate; prior v1.6.0 candidate and tag clones remain independently proved | 173 of 173 tests passed locally; the current candidate still requires public-clone and independent-CI proof |
...
| Independent secret scan | Passed on the v1.6.0 candidate and tag clones | Checksum-pinned Gitleaks `8.30.1` found no leaks in the full public Git history, candidate tree, or immutable tag tree; GitHub secret scanning and push protection provide a separate repository guard |
...
| v1.7.0 source-lock candidate | Pending external proof | Local generation and verification bind the byte-identical systemd bundle `d4918fd16f55b907a0b2b9734422d7106d3030a511e5cae5d6efc1cb7b253aba` to sixteen JSON blobs in annotated `v1.6.0` tag object `50fb6c262ded7d42a0ace55436064ab8740ca601`; source-lock canonical SHA-256 is `006db4c1633c559e159ee7c1eb23e3b5150bb6aaefcb4782a773e7b91504b688` and file SHA-256 is `1b7880ef131987bd04e766b3c647435e0ec010d1ed1db889dc43c76894b2b919`. The lock explicitly denies remote ownership, signature, runtime-source, qualification, eligibility, activation, and deployment claims. Full-history credential-disabled clone, Gitleaks, isolated schema, determinism, independent-CI, roof, tag, and release-clone proofs remain pending. |
| Demo recording | Pending applicant action | Record from immutable `v1.7.0` using the [Demo script](demo-script.md) after its release proof passes |
