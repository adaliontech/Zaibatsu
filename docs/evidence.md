...
| Independent secret scan | Passed after branding migration | Checksum-verified Gitleaks `8.30.1` scanned the complete pre-release history and release snapshot with no leaks found |
...
| Fresh-clone reproduction | Pending publication commit | Run after the public remote exists |
