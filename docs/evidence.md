...
| Independent secret scan | Passed on the v1.6.0 candidate clone and prior immutable release clones | Checksum-pinned Gitleaks `8.30.1` found no leaks in the full public Git history or candidate tree; GitHub secret scanning and push protection provide a separate repository guard |
...
| Demo recording | Pending immutable v1.6.0 release; applicant action follows | Record from the released tag using the [Demo script](demo-script.md) |
