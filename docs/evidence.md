...
| --- | --- | --- |
| Architecture validator | Passed locally after qualification-planning expansion | 68 required files, 13 components, 3 current software factories, 2 portable definition variants, 10 catalog modules and content-addressed artifacts, 1 resolved control plan and bundle manifest, 4 inspection/comparison/qualification schemas, 1 qualification policy and example plan, 11 meta-factory capabilities, 4 evidence receipts, 9 meta-factory invariants, 8 component invariants, and 10 submission gates checked; current candidate reproduction remains pending |
| Adversarial unit tests | Passed locally after qualification-planning expansion | 153 of 153 tests passed; current candidate CI and credential-disabled fresh-clone proof remain pending |
...
| Independent secret scan | Passed on v1.4.0 candidate | Checksum-pinned Gitleaks `8.30.1` found no leaks in the full public Git history or candidate tree; GitHub secret scanning and push protection provide a separate repository guard |
...
| v1.5.0 candidate proof | Pending | Canonical-JSON qualification-policy digest `4fd359cc6dfe3eb3b555eb26a3453939fde34efd8d65a281a81dd34041468e9a` and canonical-JSON qualification-plan digest `a9419341bf0806e1a6fc3769354e46ac6eb1c29043042ddd7eec35cca1a8ff81` are locally reproducible; candidate CI, strict Git, Gitleaks, AJV, and credential-disabled clone proof remain required |
